...
// Link to Logo https://fontmeme.com/permalink/200607/6b50f32a2790edff0cbdefd02aa12b9c.png
...
export const useLoginPageStyles = makeStyles({
  ...
  cardHeader: {
    backgroundImage: 'url(https://fontmeme.com/permalink/200607/6b50f32a2790edff0cbdefd02aa12b9c.png)',
    backgroundRepeat: "no-repeat",
...
export const useSignUpPageStyles = makeStyles({
  card: { maxWidth: 400, padding: "16px 40px", marginBottom: 10 },
  section: {
    display: "grid",
    placeItems: "center",
    height: "100vh"
